	...
	$.ajax({
		...
		success: function(data) {
			...
			$.each(data, function(key, value){ 
				...
				str += '<div class="col-sm-7 commentContent' + value.commentNo + '" align="left"><p>' + value.content +'</div>';				
				str += '<div class="col-sm-3">';
				str += '<button class="btn btn-sm btn-default" onclick="commentLike(' + value.commentNo + ');">좋아요</button>&nbsp';				
