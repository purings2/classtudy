...
<head>
	...
	<link rel="stylesheet" href="resouces/js/bsfunction.js">
</head>
<body>
	...
	<div class="container">
		<form class="form-horizontal" action="/member/register" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="dateOfBirth" name="dateOfBirth" class="form-control" maxlength=16 placeholder="YYMMDD로 입력하세요."/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="tel" name="tel" class="form-control" maxlength=16 placeholder="(000-0000-0000)로 입력하세요."/>
				</div>
			</div>
			<div class="form-group">
