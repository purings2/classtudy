...
<div class="content">
	<div class="container-fluid">
		...
		<form class="form-horizontal" action="/adboard/updatefreeboardNotice/${detail.boardNo}" method="post">
			<!-- 숨겨서 넘길 정보들 -->
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="category" name="category" class="form-control" value="${detail.specialInfo}" readonly/>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2">제&nbsp;&nbsp;&nbsp;&nbsp;목</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" id="title" name="title" value="${detail.title}" placeholder="제목을 작성하세요." maxlength=50/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7" align="left">
					...
					<input type="text" id="tags" name="tags" data-role="tagsinput" class="form-control" value="${detail.tags}"/>
				</div>
			...
			<footer>
				<div class="col-sm-12" align="center">
					<button type="button" class="btn btn-success" onclick="freeboardNoticeFormCheck(this.form)">수정</button>&nbsp;
