...
<div class="container" style="padding-bottom: 30px">
	...
	<form class="form-horizontal" action="/community/groupboard/write" method="post">
		<div class="form-group">
			<!-- 숨겨서 넘길 정보들 -->
			<input type="hidden" id="writer" name="writer" class="form-control" value="${member.memberId}" maxlength=16/>
			<input type="hidden" id="groupNo" name="groupNo" class="form-control" value="${viewGroup}"/>
			<!-- 보여줄 내용들 -->
		...
		<footer>
			<div class="col-sm-12" align="center">
				<button type="button" class="btn btn-success" onclick="checkGroupboardForm(this.form)">등록</button>&nbsp;
	...
	$(document).ready(function() {
		...
		$(".cancel").on("click", function() {
			if(confirm("정말 취소하시겠습니까?") == false){
				...
				location.href ="/community/groupboard/1";
			}
		});
		// Markdown Editor
		var testEditor;
