...
import com.edu.groupsearch.controller.GsCommentController;
import com.edu.groupsearch.domain.GsCommentDTO;
import com.edu.groupsearch.mapper.GsCommentMapper;

@Service("com.edu.groupsearch.service.GsCommentService")
public class GsCommentService {
 
    @Resource(name="com.edu.groupsearch.mapper.GsCommentMapper")
