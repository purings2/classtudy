		...
		<tr>
			<td align="left" style="padding-bottom: 15px; padding-left: 20px;">
				...
				<!-- 말머리 선택 : 선택된 말머리의 글만 표시 -->		
					<select class="form-control" id="viewCategory" name="viewCategory" onchange="location.href='/community/board/' + this.value">
				...
				<tr align="center">				
					...
					<td>
						<a href="/community/detail/${board.boardNo}">${board.title}</a>&nbsp;						
							<a href="/community/detail/${board.boardNo}"><span class="badge">${board.commentNum}</span></a>
					</td>
