package com.edu.groupsearch.controller;
...
import com.edu.groupsearch.service.GroupsearchService;
...
public class GroupsearchController {
	...
	public String getGroupInsert() throws Exception{
		...
		return "/groupsearch/groupInsert";
	}
	//게시물 작성 POST
	...
	return "redirect:/community/groupsearch/List";
	}
